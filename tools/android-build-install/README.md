...
The launcher still shows build output in the console while also writing it to the log. The log includes the selected project, tool paths, Gradle output, adb output, and final exit code.
